...
root_dataset = os.path.join(__root_dir__,"cifs","Triptycene_ALL_CIF")
log_dir = './logs/finetune/Tall'
downstream = "Triptycene_energy"

# kwargs (optional)
loss_names = {"classification": 0,"regression": 1,}
max_epochs = 50
batch_size = 32  # desired batch size; for gradient accumulation
per_gpu_batchsize = 8
num_workers = 12
mean = -115.928 # Triptycene_ALL_CIF
std = 30.131
test_only = True
test_to_csv = True
learning_rate = 1e-4
